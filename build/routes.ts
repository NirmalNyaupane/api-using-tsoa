...
const models: TsoaRoute.Models = {
    ...
    "CategoryEntity": {
        ...
        "properties": {
            ...
            "restaurant": {"ref":"RestaurantEnitity","required":true},
    ...
    "ProductEntity": {
        ...
        "properties": {
            ...
            "category": {"ref":"CategoryEntity","required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    "CreateOfferValidation": {
        ...
        "properties": {
            ...
            "startingDate": {"dataType":"string","required":true},
            "endingDate": {"dataType":"string","required":true},
            "products_ids": {"dataType":"array","array":{"dataType":"string"},"required":true},
        },
        "additionalProperties": false,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/restaurant',
            ...(fetchMiddlewares<RequestHandler>(RestaurantController)),
            ...(fetchMiddlewares<RequestHandler>(RestaurantController.prototype.getAllRestaurant)),

            function RestaurantController_getAllRestaurant(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAllRestaurant.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/product',
            ...
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    body: {"in":"body","name":"body","required":true,"ref":"ProductValidation"},
            };
        ...
        app.post('/offer',
            ...
            function OfferController_createOffer(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    body: {"in":"body","name":"body","required":true,"ref":"CreateOfferValidation"},
            };
        ...
        app.post('/category',
            ...
            ...(fetchMiddlewares<RequestHandler>(CategoryController.prototype.add)),

            function CategoryController_add(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
                    body: {"in":"body","name":"body","required":true,"ref":"CreateCategory"},
            };
        ...
        app.get('/category/:id',
            ...
            function CategoryController_getById(request: any, response: any, next: any) {
            const args = {
                    id: {"in":"path","name":"id","required":true,"dataType":"string"},
            };
